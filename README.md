...
- [btrfs-snapshot-compress](https://github.com/Finomosec/btrfs-snapshot-compress) — Sister project: zstd-compress existing data while preserving snapshots and reflinks (no temporary disk-grow, no `btrfs send` breakage).
